...
module spatz_controller
  ...
  #(
    ...
    input logic              [4:0]                 vfu_vs2_i,
    input logic              [4:0]                 vfu_vd_i,
    input logic              [4:0]                 vlsu0_vd_i,
    input logic              [4:0]                 vlsu1_vd_i
  );
...
`include "common_cells/registers.svh"
  ...
  logic vlsu0_vs1, vlsu0_vs2, vlsu1_vs1, vlsu1_vs2;

  logic [4:0] vlsu0_vd_d, vlsu0_vd_q, vlsu1_vd_d, vlsu1_vd_q;
  `FF(vlsu0_vd_q, vlsu0_vd_d, '0) 
  `FF(vlsu1_vd_q, vlsu1_vd_d, '0)
  ...
  always_comb begin : scoreboard
    ...
    vlsu0_vd_d              = vlsu0_vd_q;
    vlsu1_vd_d              = vlsu1_vd_q;
    ...
    vlsu0_vs1 = (vfu_vs1_i == vlsu0_vd_q);
    vlsu0_vs2 = (vfu_vs2_i == vlsu0_vd_q);
    vlsu1_vs1 = (vfu_vs1_i == vlsu1_vd_q);
    vlsu1_vs2 = (vfu_vs2_i == vlsu1_vd_q);
    ...
    if (sb_enable_i[SB_VFU_VS1_RD] || sb_enable_i[SB_VFU_VS2_RD]) begin// && sb_enable_i[SB_VFU_VS2_RD]) begin
      ...
      if (!sb_enable_i[SB_VFU_VD_RD])begin
        ...
        if (scoreboard_q[sb_id_i[SB_VFU_VS1_RD]].deps[sb_id_i[SB_VLSU0_VD_WD]] && counter0_en_q) begin
          ...
          end else if (vlsu0_vs2) begin
            vlsu0_satisfied = waddr_i[VLSU0_VD_WD] > raddr_i[VFU_VS2_RD];
          end else begin
            vlsu0_satisfied = waddr_i[VLSU0_VD_WD] > raddr_i[VFU_VD_RD];
          end 
        ...
        if (scoreboard_q[sb_id_i[SB_VFU_VS1_RD]].deps[sb_id_i[SB_VLSU1_VD_WD]] && counter1_en_q) begin
          ...
          end else if (vlsu1_vs2) begin
            vlsu1_satisfied = waddr_i[VLSU1_VD_WD] > raddr_i[VFU_VS2_RD];
          end else begin
            vlsu1_satisfied = waddr_i[VLSU1_VD_WD] > raddr_i[VFU_VD_RD];
          end 
